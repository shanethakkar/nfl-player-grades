...
| 14 | New position | Kickers v1 (full audit-first process) | 1-1.5 day | **SHIPPED 2026-05-14** ([audit](audits/2026-05-14-exhaustive-k.md), [ADR](../adr/0023-k-v1-grading-formula.md)) — 4 components: fg_pct_40_plus (+0.40), fg_pct (+0.25), pat_pct (+0.15), fg_long (+0.10). Validity +0.165 (lowest of any position — kicker stats are structurally noisy). First new position designed audit-first; 5 candidates rejected with documented reasoning. Face-check: Boswell #1 2024, Tucker #28 after collapse. |
